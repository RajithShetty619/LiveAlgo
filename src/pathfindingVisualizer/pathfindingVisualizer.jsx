...
class PathfindingVisualizer extends Component {
  ...
  generateCustomMaze(){
    this.setState(()=>{
      ...
      let variable = localStorage.getItem('grid')
      const grid = JSON.parse(variable) 
    ...
    return (
      <React.Fragment>
        <NavBar
          ...
          printMaze={this.printMaze.bind(this)}
          generateCustomMaze={this.generateCustomMaze.bind(this)}
